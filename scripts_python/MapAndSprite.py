...
##### Limite pour les déplacements vers le haut
...
##### Limite des déplacements vers le bas
...
##### Limite des déplacements vers la gauche
...
##### Limite des déplacements vers la droite
